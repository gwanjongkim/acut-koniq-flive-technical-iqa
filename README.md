...
The technical score combines two mobile-friendly technical quality models.

- KonIQ-based model: captures general no-reference perceptual quality.
- FLIVE-based model: captures real-world mobile/in-the-wild technical quality signals.
...
- KonIQ-10k: 2,015 images
- SPAQ: 1,125 images
- FLIVE image test: 1,827 images

## Model Weights / Artifacts

Model binaries larger than normal GitHub limits are not included directly. Use models/download.md for artifact placement and hosting notes.
